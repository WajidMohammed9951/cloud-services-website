        ...
        <div className="flex flex-col gap-8 md:flex-row items-center justify-center w-full">
          ...
          <div className="w-3/4 md:w-1/2">
            <div className="grid grid-cols-2 mx-auto w-4/5 gap-10">
              <div className="flex items-center justify-center rounded-md shadow-md shadow-green-600 p-3 cursor-pointer hover:scale-105 duration-200 ease-in">
                <FaFacebook size={25} />
              </div>
              <div className="flex items-center justify-center rounded-md shadow-md shadow-green-600 p-3 cursor-pointer hover:scale-105 duration-200 ease-in">
                <FaLinkedin size={25} />
          ...
          <div className="w-3/4 md:w-1/2">
            <div className="w-full pt-8 md:pt-2">
              ...
              <form
                action="https://getform.io/f/e7a869c4-aef4-4184-99a3-deee41de922b"
                method="POST"
